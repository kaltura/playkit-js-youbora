...
_youboraLib2.default.plugins.KalturaV3 = function (player, options) {
  try {
    ...
    this.pluginVersion = _youboraLib2.default.version + '-' + pkg.version + '-' + _playkitJs.PLAYER_NAME;
